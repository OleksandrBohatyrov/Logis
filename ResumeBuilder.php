    ...
    <main id="main">
        ...
        <div class="breadcrumbs">
            <div class="page-header d-flex align-items-center"
                style="background-image: url('assets/img/page-header.jpg')"></div>
        </div>
        <!-- End Breadcrumbs -->
                ...
                <div class="row gy-4">
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                        <div class="card">
                            ...
                            <h3>
                                <a href="service-details.html" class="stretched-link">Storage Specialist</a>
                            </h3>
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                        <div class="card">
                            ...
                            <h3>
                                <a href="service-details_logistic.html" class="stretched-link">Logistics Specialist</a>
                            </h3>
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
                        <div class="card">
                            ...
                            <h3>
                                <a href="service-details_cargo.html" class="stretched-link">Cargo Operator</a>
                            </h3>
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
                        <div class="card">
                            ...
                            <h3>
                                <a href="service-details.html" class="stretched-link">Truck Driver</a>
                            </h3>
                            <p>
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="500">
                        <div class="card">
                            ...
                            <h3>
                                <a href="service-details.html" class="stretched-link">Packaging Specialist</a>
                            </h3>
                            <p>
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                        <div class="card">
                            ...
                            <h3>
                                <a href="service-details.html" class="stretched-link">IT Developer</a>
                            </h3>
                            <p>
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-2 col-6 footer-links">
                    ...
                    <ul>
                        ...
                        <li><a href="CVKeskus.php">Maxx CV Keskus</a></li>
